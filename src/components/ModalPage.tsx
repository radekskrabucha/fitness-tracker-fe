...
export const ModalPage: FlowComponent<ModalPageProps> = props => (
  <>
    ...
    />
    <div class="show fixed top-[50%] left-[50%] flex h-[min(80vh,var(--width-lg))] w-[min(calc(100vw-48px),var(--width-3xl))] translate-x-[-50%] translate-y-[-50%] flex-col overflow-hidden rounded-3xl border border-white shadow-lg backdrop-blur-lg">
